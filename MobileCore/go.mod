...
// MiClash SS2022 maximum-record allocation fix. See THIRD_PARTY_PATCHES.md.
// The version qualifier prevents this patch from being applied silently after
// Mihomo moves to a different sing-shadowsocks2 release.
replace github.com/metacubex/sing-shadowsocks2 v0.2.7 => ./third_party/sing-shadowsocks2
