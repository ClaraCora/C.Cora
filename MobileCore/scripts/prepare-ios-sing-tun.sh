...
readonly SOURCE_REL="internal/fdbased_darwin/processors.go"
readonly EXPECTED_SOURCE_SHA="4a140130e600a373754218ebefa94db9fd3d18e8ec56136ebad881e60debde94"
readonly EXPECTED_PATCHED_SHA="200cf2bdb826b72ea66fcfd2be0239f1742c193590edd400857dd8dd42eab0dc"
readonly PATCH_FILE="${GITHUB_WORKSPACE:?}/MobileCore/dependency-patches/sing-tun-v0.4.21-darwin-queue.patch"
readonly PATCHED_DIR="${RUNNER_TEMP:?}/sing-tun-v0.4.21-ios-memory-v1"
